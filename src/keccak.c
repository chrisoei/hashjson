...
void SHA3_256_Init( tKeccakLane * state )
{
    memset( state, 0, 5*5*sizeof(tKeccakLane) );
}

void SHA3_256_Update( tKeccakLane * state, const unsigned char *in, unsigned long long inlen )
{
...
void SHA3_256_Final( unsigned char * out, tKeccakLane * state )
{
